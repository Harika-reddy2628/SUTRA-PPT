...
export const Slide01Title: React.FC = () => {
  return (
    <div className="relative w-full h-full bg-[#FAF7F2] text-[#183A2B] font-sans flex flex-col justify-between p-16 lg:p-20 select-none">
      
      {/* Top Left Tag: Team Offgrid & Classification */}
