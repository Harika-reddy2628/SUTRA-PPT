...
export const Slide03Benchmark: React.FC = () => {
  return (
    <div className="relative w-full h-full bg-[#FFFFFF] text-[#000000] font-sans flex flex-col justify-between p-7 lg:p-11 select-none overflow-hidden border border-[#E4E4E7]">
      ...
      <div className="relative z-10 h-full flex flex-col justify-between">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between pt-1 gap-2">
          ...
          <div className="flex flex-wrap items-center gap-2 font-mono text-[10.5px] text-slate-600">
            <span className="px-2.5 py-1 rounded-md bg-slate-100 border border-slate-200">10-18 MIN/MI²</span>
            <span className="px-2.5 py-1 rounded-md bg-emerald-50 border border-emerald-200 text-emerald-700 font-bold">78-85% DETECTION</span>
            <span className="px-2.5 py-1 rounded-md bg-slate-100 border border-slate-200">12% FALSE POSITIVES</span>
            <span className="px-2.5 py-1 rounded-md bg-emerald-50 border border-emerald-200 text-emerald-700 font-bold">$12K SORTIE</span>
          </div>
        </div>
        ...
        <main className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5 items-stretch my-auto">
          ...
          <div className="flex flex-col justify-between p-4 lg:p-5 rounded-2xl border border-slate-200 bg-white hover:border-emerald-400 hover:shadow-md transition-all group relative overflow-hidden space-y-3 shadow-sm">
            <div className="space-y-2.5">
              ...
              <div>
                <span className="text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest">SUBSYSTEM A</span>
                <h3 className="text-base lg:text-lg font-bold text-slate-900 font-heading leading-snug mt-0.5">
                  SUTRA-FSD GNC &amp; 3D ORCA
                </h3>
              </div>

              {/* Problem Solved Pill */}
              <div className="p-2 rounded-lg bg-red-50/70 border border-red-200/80">
                <div className="text-[8.5px] font-mono font-bold text-red-700 uppercase">SOLVES PROBLEM VOID:</div>
                <div className="text-[10.5px] font-semibold text-slate-800 leading-tight mt-0.5">Canopy GPS Multi-Path Drift &amp; Crashes</div>
              </div>

              {/* Technological Moat */}
              <div className="p-2 rounded-lg bg-slate-50 border border-slate-200 space-y-1">
                <div className="text-[9px] font-mono font-bold text-emerald-700 uppercase">SOLUTIONAL MOAT:</div>
              ...
              <div className="grid grid-cols-2 gap-1.5 text-center font-mono">
                <div className="p-1 rounded bg-slate-50 border border-slate-100">
                  <div className="text-[11px] font-bold text-slate-900">0.05s</div>
                  <div className="text-[8px] text-slate-400">Response Latency</div>
                </div>
                <div className="p-1 rounded bg-slate-50 border border-slate-100">
                  <div className="text-[11px] font-bold text-emerald-700">0 Tower</div>
                  <div className="text-[8px] text-slate-400">Dependency</div>
                </div>
              </div>
            </div>

            <div className="pt-2.5 border-t border-slate-100 flex items-center justify-between text-[9.5px] font-mono text-slate-400">
              <span>DECENTRALIZED VIO</span>
              <span className="text-emerald-600 font-bold">50Hz RATE</span>
            </div>
          ...
          <div className="flex flex-col justify-between p-4 lg:p-5 rounded-2xl border border-slate-200 bg-white hover:border-emerald-400 hover:shadow-md transition-all group relative overflow-hidden space-y-3 shadow-sm">
            <div className="space-y-2.5">
              <div className="flex justify-between items-center pb-2 border-b border-slate-100">
                ...
                <span className="font-mono text-[9.5px] font-bold text-slate-800 bg-slate-100 border border-slate-200 px-2 py-0.5 rounded">
                  -5dB RESILIENT
                </span>
              </div>
              
              <div>
                <span className="text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest">SUBSYSTEM B</span>
                <h3 className="text-base lg:text-lg font-bold text-slate-900 font-heading leading-snug mt-0.5">
              ...
              <div className="p-2 rounded-lg bg-red-50/70 border border-red-200/80">
                <div className="text-[8.5px] font-mono font-bold text-red-700 uppercase">SOLVES PROBLEM VOID:</div>
                <div className="text-[10.5px] font-semibold text-slate-800 leading-tight mt-0.5">Mountain Ravine RF Ridge Blackout</div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-1.5 text-center font-mono">
                <div className="p-1 rounded bg-slate-50 border border-slate-100">
                  <div className="text-[11px] font-bold text-slate-900">-5dB</div>
                  <div className="text-[8px] text-slate-400">SNR Threshold</div>
                </div>
                <div className="p-1 rounded bg-slate-50 border border-slate-100">
                  <div className="text-[11px] font-bold text-emerald-700">0 Cliff</div>
                  <div className="text-[8px] text-slate-400">Degradation</div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-2.5 border-t border-slate-100 flex items-center justify-between text-[9.5px] font-mono text-slate-400">
              ...
              <span className="text-slate-800 font-bold">EDGE TPU</span>
            </div>
            <div className="h-1 w-full bg-slate-800 absolute bottom-0 left-0"></div>
          </div>
          ...
          <div className="flex flex-col justify-between p-4 lg:p-5 rounded-2xl border border-slate-200 bg-white hover:border-emerald-400 hover:shadow-md transition-all group relative overflow-hidden space-y-3 shadow-sm">
            <div className="space-y-2.5">
              ...
              <div>
                <span className="text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest">SUBSYSTEM C</span>
                <h3 className="text-base lg:text-lg font-bold text-slate-900 font-heading leading-snug mt-0.5">
              ...
              <div className="p-2 rounded-lg bg-red-50/70 border border-red-200/80">
                <div className="text-[8.5px] font-mono font-bold text-red-700 uppercase">SOLVES PROBLEM VOID:</div>
                <div className="text-[10.5px] font-semibold text-slate-800 leading-tight mt-0.5">35% False Alarms &amp; Flat GPS Drift</div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-1.5 text-center font-mono">
                <div className="p-1 rounded bg-slate-50 border border-slate-100">
                  <div className="text-[11px] font-bold text-slate-900">&lt;15ms</div>
                  <div className="text-[8px] text-slate-400">Inference Time</div>
                </div>
                <div className="p-1 rounded bg-slate-50 border border-slate-100">
                  <div className="text-[11px] font-bold text-emerald-700">3.59cm</div>
                  <div className="text-[8px] text-slate-400">Geo Error</div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-2.5 border-t border-slate-100 flex items-center justify-between text-[9.5px] font-mono text-slate-400">
              ...
              <span className="text-emerald-600 font-bold">JETSON ORIN</span>
            </div>
            <div className="h-1 w-full bg-emerald-500 absolute bottom-0 left-0"></div>
          </div>
          ...
          <div className="flex flex-col justify-between p-4 lg:p-5 rounded-2xl border border-slate-200 bg-white hover:border-emerald-400 hover:shadow-md transition-all group relative overflow-hidden space-y-3 shadow-sm">
            <div className="space-y-2.5">
              ...
              <div>
                <span className="text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest">SUBSYSTEM D</span>
                <h3 className="text-base lg:text-lg font-bold text-slate-900 font-heading leading-snug mt-0.5">
              ...
              <div className="p-2 rounded-lg bg-red-50/70 border border-red-200/80">
                <div className="text-[8.5px] font-mono font-bold text-red-700 uppercase">SOLVES PROBLEM VOID:</div>
                <div className="text-[10.5px] font-semibold text-slate-800 leading-tight mt-0.5">15-25 Ground Crew Cognitive Overload</div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-1.5 text-center font-mono">
                <div className="p-1 rounded bg-slate-50 border border-slate-100">
                  <div className="text-[11px] font-bold text-slate-900">1-2 Ops</div>
                  <div className="text-[8px] text-slate-400">Crew Size</div>
                </div>
                <div className="p-1 rounded bg-slate-50 border border-slate-100">
                  <div className="text-[11px] font-bold text-emerald-700">100%</div>
                  <div className="text-[8px] text-slate-400">Offline ATAK</div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-2.5 border-t border-slate-100 flex items-center justify-between text-[9.5px] font-mono text-slate-400">
              ...
              <span className="text-slate-800 font-bold">WEBGPU 3D</span>
            </div>
            <div className="h-1 w-full bg-slate-800 absolute bottom-0 left-0"></div>
          </div>
